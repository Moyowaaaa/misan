  ...
  return (
    <>
      ...
      >
        ...
        >
          {image && (
            <div className="h-[20rem] overflow-hidden max-h-[20rem] ">
              <Image
                src={image}
                alt={title}
                width={500}
        ...
        <CardFooter className="px-2 pb-2 flex items-center gap-2 py-4">
          ...
          {appLinks?.map((link: any, index: any) => (
            <a
              href={link.link}
              target="_blank"
            ...
            >
              ...
              {link.name === "website" && (
                <div className="flex item-center gap-2 text-white hover:border-b-2 hover:border-b-[skyblue]">
                  <p>Visit Website</p>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width=" 25"
